    ...
    <div class="row">
        <div class="col-md-2">
            ...
            <div class="list-group ">
                ...
                @if(count($articles)>0)
                    @foreach($articles as $cate_article)
                        <a href="{{route('category_article',[$category,$cate_article])}}" class="list-group-item list-group-item-action"
                           style="padding: 0.2rem 0.3rem;">{{$cate_article['title']}}</a>
                    @endforeach
                @endif
            </div>
        </div>
